...
TEST_F(STA_TAOCP_Book_Test, STA_With_All_BytesField_Gets_All_Except_Sign)
{
	...
	ASSERT_EQ(dest_word().byte(1), Byte{6});
	ASSERT_EQ(dest_word().byte(2), Byte{7});
	ASSERT_EQ(dest_word().byte(3), Byte{8});
	ASSERT_EQ(dest_word().byte(4), Byte{9});
	ASSERT_EQ(dest_word().byte(5), Byte{10});
}
...
TEST_F(STA_TAOCP_Book_Test, STA_With_RightMost_Field_Sets_Byte_Without_Shift)
{
	...
	ASSERT_EQ(dest_word().sign(), Sign::Negative);
	ASSERT_EQ(dest_word().byte(1), Byte{1});
	ASSERT_EQ(dest_word().byte(2), Byte{2});
	ASSERT_EQ(dest_word().byte(3), Byte{3});
	ASSERT_EQ(dest_word().byte(4), Byte{4});
	ASSERT_EQ(dest_word().byte(5), Byte{10});
}
...
TEST_F(STA_TAOCP_Book_Test, STA_With_One_ByteField_Length_Gets_Value_From_5_RA_Byte)
{
	...
	ASSERT_EQ(dest_word().sign(), Sign::Negative);
	ASSERT_EQ(dest_word().byte(1), Byte{1});
	ASSERT_EQ(dest_word().byte(2), Byte{10});
	ASSERT_EQ(dest_word().byte(3), Byte{3});
	ASSERT_EQ(dest_word().byte(4), Byte{4});
	ASSERT_EQ(dest_word().byte(5), Byte{5});
}
...
TEST_F(STA_TAOCP_Book_Test, STA_With_Two_ByteField_Length_Gets_Value_From_Last_Two_RA_Bytes)
{
	...
	ASSERT_EQ(dest_word().sign(), Sign::Negative);
	ASSERT_EQ(dest_word().byte(1), Byte{1});
	ASSERT_EQ(dest_word().byte(2), Byte{9});
	ASSERT_EQ(dest_word().byte(3), Byte{10});
	ASSERT_EQ(dest_word().byte(4), Byte{4});
	ASSERT_EQ(dest_word().byte(5), Byte{5});
}
...
TEST_F(STA_TAOCP_Book_Test, STA_With_One_Sign_ByteField_Gets_Value_From_5_RA_Byte_And_Its_Sign)
{
	...
	ASSERT_EQ(dest_word().byte(1), Byte{10});
	ASSERT_EQ(dest_word().byte(2), Byte{2});
	ASSERT_EQ(dest_word().byte(3), Byte{3});
	ASSERT_EQ(dest_word().byte(4), Byte{4});
	ASSERT_EQ(dest_word().byte(5), Byte{5});
